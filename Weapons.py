...
class BasicWeapon:
    ...
    def __init__(self, weapon):
        ...
        # "weakref"
        # self.ammo_sprite = weapon["ammo sprite"]
        # if type(self.ammo_sprite) == str:
        #     self.ammo_sprite = pg.image.load(os.path.join(self.ammo_sprite)).convert_alpha()
...
weapon_repertory = {
    ...
    "Saloum Mk-2":
        {"name": "Saloum Mk-2",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Missile"],
    ...
    "GMG-04B":
        {"name": "GMG-04B",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Throwable"],
    ...
    "GunBlade":
        {"name": "GunBlade",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Slash"],
    ...
    "Corrine's Old Rifle":
        {"name": "Corrine's Old Rifle",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Rifle"],
         "gunshot sound": "Rifle",
         "reloading sound": "Reload Pistol 1",
         "jamming sound": "Jamming",
         "sound level": 0.9,
    ...
    "Jeanne's Family Shotgun":
        {"name": "Jeanne's Family Shotgun",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Shotgun"],
    ...
    "Custom Mk18 Laser cutter":
        {"name": "Custom Mk18 Laser cutter",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Blunt"],
    ...
    "Epicurean Medic Rifle":
        {"name": "Epicurean Medic Rifle",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Semi-auto"],
         "gunshot sound": "Small arms",
         "reloading sound": "Reload Pistol 1",
         "jamming sound": "Jamming",
         "sound level": 0.8,
    ...
    "Nihilist Stretcher":
        {"name": "Nihilist Stretcher",
         ...
         "ammo sprite": Fun.AMMO_BAR_SPRITES["Flame"],
         "gunshot sound": "Silence",
         "reloading sound": "Silence",
         "jamming sound": "Silence",
         "sound level": 0,
